...
public class CreateVehicleController {
    ...
    public void createButtonClick(){
        if (!modelField.getText().isEmpty() & !licenceField.getText().isEmpty()){
            returningValue = new String[2];
            returningValue[0] = modelField.getText();
            returningValue[1] = licenceField.getText();
        }
